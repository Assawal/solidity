...
std::string Data::toString(YulNameRepository const*, DebugInfoSelection const&, CharStreamProvider const*) const
{
...
) const
{
	...
	for (auto const& obj: subObjects)
		inner += "\n" + obj->toString(_yulNameRepository, _debugInfoSelection, _soliditySourceProvider);
