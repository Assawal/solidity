...
{
public:
	explicit ObjectParser(langutil::ErrorReporter& _errorReporter, Dialect const& _dialect, YulNameRepository& _yulNameRepository):
		ParserBase(_errorReporter), m_dialect(_dialect), m_yulNameRepository(_yulNameRepository) {}
