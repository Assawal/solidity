...
void UnusedStoreEliminator::run(OptimiserStepContext& _context, Block& _ast)
{
	...
	Expression const zeroLiteral{Literal{{}, LiteralKind::Number, 0, {}}};
	Expression const oneLiteral{Literal{{}, LiteralKind::Number, 1, {}}};
	Expression const thirtyTwoLiteral{Literal{{}, LiteralKind::Number, 32, {}}};
