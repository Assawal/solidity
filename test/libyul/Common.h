...
parse(std::string const& _source, YulNameRepository& _yulNameRepository, langutil::ErrorList& _errors);

std::tuple<Block, std::unique_ptr<YulNameRepository>> disambiguate(std::string const& _source, bool _yul = true);
